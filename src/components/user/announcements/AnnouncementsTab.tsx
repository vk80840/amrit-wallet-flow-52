    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {filteredAnnouncements.map((announcement) => (
          <div 
            key={announcement.id} 
            className={`bg-white/70 backdrop-blur-lg border border-white/20 shadow-xl rounded-xl p-6 ${
      ...
      {filteredAnnouncements.length === 0 && (
        <div className="bg-white/70 backdrop-blur-lg border border-white/20 shadow-xl rounded-xl p-12">
